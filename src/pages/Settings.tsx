    ...
    <div className="space-y-4 lg:space-y-6">
                    ...
                    <button
                      ...
                      className={`flex-1 flex items-center justify-center gap-2 px-4 py-3 rounded-lg border-2 transition-all ${
                        theme === 'light'
                          ...
                          : 'border-slate-300 dark:border-white/20 hover:border-accent-light text-slate-600 dark:text-white'
                      }`}
                    >
            ...
            {activeTab === 'about' && (
              <div className="space-y-6">
                ...
                <div className="text-center py-8">
                  ...
                  <p className="text-slate-600 dark:text-slate-300 mb-4">Water Quality Monitoring System</p>
      ...
      <div className="flex flex-col sm:flex-row justify-between items-center gap-3 p-4 bg-white dark:bg-white/10 backdrop-blur-lg/50 rounded-xl border border-slate-300 dark:border-white/20">
        <button
          ...
          className="w-full sm:w-auto px-4 py-2 text-slate-600 dark:text-slate-300 hover:text-slate-800 dark:hover:text-white transition-colors flex items-center justify-center gap-2"
        >
